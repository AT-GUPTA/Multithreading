...
public class Client extends Thread {
    ...
    public void run() {
        ...
        if (getClientOperation().equalsIgnoreCase("sending")) {
            //System.out.println("\nTransfering transactions to the network input buffer...");
            sendClientStartTime = System.currentTimeMillis();
            sendTransactions();
            sendClientEndTime = System.currentTimeMillis();
            System.out.println("\n Terminating client sending thread - " + " Running time " + (sendClientEndTime - sendClientStartTime) + " milliseconds");
        } else if (getClientOperation().equalsIgnoreCase("receiving")) {
            //System.out.println("\nRetrieving the updated transactions from the network output buffer...");
